...
const TARGET = ["Paco Rabanne","Versace","Lancôme","Jean Paul Gaultier","Dolce & Gabbana","Dolce&Gabbana","Valentino","Montale","Nishane","Roja Dove","Xerjoff","Maison Francis Kurkdjian"];
...
`;
fs.writeFileSync("./scripts/wf-reprice-research4.js", script);
