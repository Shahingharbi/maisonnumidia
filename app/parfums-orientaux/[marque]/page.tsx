    ...
    <>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="mb-8">
            <Breadcrumb items={[{ label: "Parfums Orientaux", href: "/parfums-orientaux" }, { label: brand.name, href: `/parfums-orientaux/${brand.slug}` }]} />
          </div>
      ...
      <section className="bg-[#FAFAF8] py-14 sm:py-20 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-5 text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <BrandCrossLinks section="parfums-orientaux" currentSlug={marque} />
          </div>
        </div>
      </section>
    </>
